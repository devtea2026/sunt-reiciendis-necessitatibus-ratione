...
`@devtea2026/sunt-reiciendis-necessitatibus-ratione` is a library for generating terminal commands in a simple and straight-forward way. 
...
```bash
npm i @devtea2026/sunt-reiciendis-necessitatibus-ratione
```
...
```js
// ESM
import { Command } from '@devtea2026/sunt-reiciendis-necessitatibus-ratione'

// CommonJS
const { Command } = require('@devtea2026/sunt-reiciendis-necessitatibus-ratione')
```
...
`@devtea2026/sunt-reiciendis-necessitatibus-ratione` provides a list of output methods to use instead of/in addition to using `console`:
